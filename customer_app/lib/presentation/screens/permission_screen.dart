                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          const Text(
                            'To give you the best experience, GlowBook requires access to device permissions. Mandatory services are required to continue.',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 13,
                          ...
                          _buildPermissionCard(
                            ...
                            description: 'Find nearby salons & calculate travel distances.\nGPS Status: ${locationState.errorMessage ?? "Active"}',
                          ...
                          if (!permissionState.isLocationGranted)
                            Padding(
                              ...
                              child: Text(
                                '* Nearby salons unavailable without location permission.',
                          ...
                          _buildPermissionCard(
                            ...
                            description: 'Alerts you about appointment status, changes, and reminder alerts.',
                          ...
                          if (!permissionState.isNotificationGranted)
                            Padding(
                              padding: const EdgeInsets.only(top: 6, left: 4),
                              child: Text(
                                '* Booking alerts and updates unavailable without notification permission.',
                                style: TextStyle(color: Colors.red[300], fontSize: 11, fontWeight: FontWeight.bold),
                              ),
                            ),
                          ...
                          _buildPermissionCard(
                            title: 'Camera Access',
                            description: 'Required for profile photo upload and scanning QR codes.',
                          ...
                          _buildPermissionCard(
                            title: 'Photo Gallery',
                            description: 'Select and set a custom profile background or avatar.',
                          ...
                          _buildPermissionCard(
                            title: 'Storage / Files',
                            description: 'Read and write app files, receipts, and temporary resources.',
                          ...
                          _buildPermissionCard(
                            ...
                            description: 'Record voice messages or review details inside app comments.',
                          ...
                          _buildPermissionCard(
                            ...
                            description: 'Autofill confirmation codes and verify your phone number.',
